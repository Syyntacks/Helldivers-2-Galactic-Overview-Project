...
def main_program():
    ...
    mo_overview_endpoint = api_endpoints.api_endpoints.get("mo_overview")
    if mo_overview_endpoint:
        major_orders_data = data_fetcher.fetch_data_from_endpoint(mo_overview_endpoint)
